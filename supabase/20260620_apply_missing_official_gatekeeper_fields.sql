-- AIPOGER Official Gatekeeper Drop production repair patch.
-- Safe to run more than once.
--
-- Purpose:
-- Some production projects already have official_gatekeeper_drops and media
-- fields, but are missing the queue/battle columns required to create a
-- per-challenge Battle Room from an official gatekeeper card.
