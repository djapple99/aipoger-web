...
> 2026-09-06 文件分層：本檔保留協作背景／舊速查，產品現況請先讀 [文件入口](README.md) 與 `docs/aipoger-product-rules.md`。舊 24H 入口、過期套件版本、未完成待辦及只選 Showtime 的 Choice 摘要不能視為當前實作。Q Crash 與耳朵蟲現況以產品規則為準。
