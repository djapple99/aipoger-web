...
2026-09-21 Choice 整批發布：版面、分享封面與批次編輯完成，459 項測試通過。正式 migration `20260921132314_creator_choice_batch_editor` 已套用；[發布紀錄](archive/2026-09-21-choice-batch-release.md)。
