...
- 三個音樂展示面的定位不可混淆：傷心酒吧是 AI 音樂公播池與投稿入口；探索 AI 音樂是公開上傳作品牆；Showtime 是認證作品庫。Showtime 作品入選後不再接受挑戰；未進 Showtime 的探索作品若累積 8 場正式敗績，會從探索公開牆退場並停止接戰，只計入至少 3 位非參賽者投票成立的正式敗績。
