...
## AIPOGER Drop Battle 連戰挑戰記憶（待實作）

- 明天優先規劃 / 實作「賽後 7 秒挑戰」：Drop Battle 宣布得獎者後，不要立刻清掉戰鬥池卡片，先給全場 7 秒倒數詢問是否有人要挑戰。
- 7 秒只用來搶挑戰資格；有人按「我要挑戰」後，挑戰者取得挑戰席，再給約 120 秒上傳歌曲與分享挑戰連結，不要求 7 秒內完成上傳。
...
- 如果上一場是 0:0 no contest，不能產生擂主，也不應進入 7 秒挑戰流程。
