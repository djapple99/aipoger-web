      ...
      <div className="mx-auto max-w-7xl">
        <header className="flex flex-wrap items-start justify-between gap-4 border-b border-white/10 pb-5">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm font-bold leading-6 text-zinc-400">管理自己的 Showtime 展示資料與外部導流連結，並從目前公開展示中的 Showtime 作品策展自己的 Choice。</p>
          </div>
