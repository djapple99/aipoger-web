...
export default function ListenBarPage() {
  ...
  const listenCopy = isZh
    ? {
        ...
        channelCountLabel: `${LISTEN_BAR_GENRES.length + 1} 個播放頻道`,
    ...
    : lang === "ja"
      ? {
          ...
          channelCountLabel: `${LISTEN_BAR_GENRES.length + 1}チャンネル`,
      ...
      : lang === "ko"
        ? {
            ...
            channelCountLabel: `${LISTEN_BAR_GENRES.length + 1}개 채널`,
        ...
        : {
            ...
            channelCountLabel: `${LISTEN_BAR_GENRES.length + 1} CHANNELS`,
