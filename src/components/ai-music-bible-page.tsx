...
function practiceAreasForLanguage(isZh: boolean): PracticeArea[] {
  return isZh
    ? [
        ...
        { icon: WandSparkles, eyebrow: "PROMPT", title: "Prompt 招式庫", body: "118 招 Prompt、80+ 個曲風詞與愛波哥私藏配方。", href: "#suno-prompt-library", accent: "orange" },
    ...
    : [
        ...
        { icon: WandSparkles, eyebrow: "PROMPT", title: "Prompt Moves", body: "118 prompt moves, 80+ genre terms, and curated AIPOGER recipes.", href: "#suno-prompt-library", accent: "orange" },
