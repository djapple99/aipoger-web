...
function practiceAreasForLanguage(isZh: boolean): PracticeArea[] {
  return isZh
    ? [
        ...
        { icon: WandSparkles, eyebrow: "PROMPT", title: "Prompt 招式庫", body: "158 招 Prompt、含鼓、吉他、鋼琴、合成器、Bass、麥克風與混音方向。", href: "#suno-prompt-library", accent: "orange" },
        ...
        { icon: Music2, eyebrow: "DROP", title: "Drop 製作練習", body: "用 30–60 秒練節奏、情緒與記憶點。", href: "/drop-guide", accent: "orange" },
    ...
    : [
        ...
        { icon: WandSparkles, eyebrow: "PROMPT", title: "Prompt Moves", body: "158 prompt moves, including drums, guitars, keys, synths, bass, microphones, effects, and mix direction.", href: "#suno-prompt-library", accent: "orange" },
        ...
        { icon: Music2, eyebrow: "DROP", title: "Drop Practice", body: "Train rhythm, emotion, and recall inside a focused 30–60 seconds.", href: "/drop-guide", accent: "orange" },
