export const ADMIN_TASKS = [
  ...
  { id: "promotion", href: "/admin/listen-bar", label: "新歌待宣傳" },
  { id: "choice", href: "/admin/choice", label: "官方 Choice 草稿" },
...
export const adminTaskTotal = (data: AdminTasks | null) => data
  ? Object.values(data.counts).reduce<number>((sum, count) => sum + (count ?? 0), 0) : 0;
