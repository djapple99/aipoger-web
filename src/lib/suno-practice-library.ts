...
export const SUNO_LYRIC_MOVES: SunoTechnique<SunoLyricCategory>[] = [
  ...
  },
  {
    ...
    summary: { zh: "用可聽見的唱法與質地取代空泛的「好聽」；一次先選一個主唱法，再加一個音色或情緒 cue。", en: "Replace vague requests like 'sing beautifully' with audible delivery and texture; start with one primary delivery cue, then add one texture or emotion cue." },
    use: { zh: "歌手個性不明確時", en: "When the singer lacks a distinct character" },
    copy: { zh: "唱法詞庫（每段挑 1–3 個）：\n[whisper] [breathy] [spoken] [sung] [yell] [scream] [growl] [raspy] [strained] [crack in voice]\n[falsetto] [soulful] [smooth] [raw] [haunting] [dark] [soft] [powerful] [emotional]\n[belting] [crooning] [scat]\n\n示範：\n[Verse | spoken | soft | close mic]\n[Pre-Chorus | breathy | soulful | emotional build-up]\n[Chorus | sung | powerful | emotional]", en: "Delivery bank (choose 1–3 per section):\n[whisper] [breathy] [spoken] [sung] [yell] [scream] [growl] [raspy] [strained] [crack in voice]\n[falsetto] [soulful] [smooth] [raw] [haunting] [dark] [soft] [powerful] [emotional]\n[belting] [crooning] [scat]\n\nExample:\n[Verse | spoken | soft | close mic]\n[Pre-Chorus | breathy | soulful | emotional build-up]\n[Chorus | sung | powerful | emotional]" },
    evidence: "field",
    sources: ["使用者提供的 Suno Vocal Direction Cheat Sheet 圖片", "SUNO Prompt", "Suno Music Glossary"],
    keywords: ["whisper", "falsetto", "belting", "crooning", "vocal"],
  },
  {
    key: "vocal-character-tone",
    category: "vocal",
    title: { zh: "人聲角色與音色", en: "Vocal character and tone" },
    summary: { zh: "先定義聲音的年齡／性別角色，再補一個性格或情緒方向；不要把互相衝突的角色一次全塞進同一段。", en: "Define the vocal age or gender character first, then add one personality or emotional direction; do not stack conflicting identities in one section." },
    use: { zh: "人聲音色漂移、角色不像預期時", en: "When the vocal identity drifts away from the intended character" },
    copy: { zh: "角色詞庫：\n[young] [mature] [female] [male] [androgynous] [childlike]\n[seductive] [confident] [vulnerable] [angry] [sad] [playful] [desperate] [tired] [broken] [hopeful] [calm] [melancholic] [intense]\n\n示範：\n[Verse | female | mature | vulnerable]\n[Chorus | confident | hopeful | intense]", en: "Character bank:\n[young] [mature] [female] [male] [androgynous] [childlike]\n[seductive] [confident] [vulnerable] [angry] [sad] [playful] [desperate] [tired] [broken] [hopeful] [calm] [melancholic] [intense]\n\nExample:\n[Verse | female | mature | vulnerable]\n[Chorus | confident | hopeful | intense]" },
    evidence: "field",
    sources: ["使用者提供的 Suno Vocal Direction Cheat Sheet 圖片"],
    keywords: ["young", "mature", "female", "male", "androgynous", "childlike", "vulnerable", "角色", "音色"],
  },
  {
    key: "emotion-line",
    category: "emotion",
  ...
  },
  {
    ...
    summary: { zh: "效果是製作層，不是歌手身份；放在需要的段落，一次先挑 1–2 個，整首開滿容易失去反差與清晰度。", en: "Effects are a production layer, not the singer's identity; place them locally and start with 1–2 cues, because using them everywhere removes contrast and clarity." },
    use: { zh: "想做轉場、復古、機器人或失真人聲時", en: "For transitions, vintage color, robotic voices, or distortion" },
    copy: { zh: "效果詞庫（每段挑 1–2 個）：\n[echo] [reverb] [delay] [distorted] [lo-fi] [radio effect] [telephone effect] [autotune] [vintage] [vocoder] [heavy reverb]\n[double tracked] [harmonized] [vocal run] [ad-lib] [background vocals] [choir] [stutter] [tremolo] [filter] [widened]\n\n示範：\n[Intro | filtered vocals | telephone effect]\n[Chorus | clean lead vocal | harmonized | widened]\n[Outro | vintage | echo | fade out]", en: "Effects bank (choose 1–2 per section):\n[echo] [reverb] [delay] [distorted] [lo-fi] [radio effect] [telephone effect] [autotune] [vintage] [vocoder] [heavy reverb]\n[double tracked] [harmonized] [vocal run] [ad-lib] [background vocals] [choir] [stutter] [tremolo] [filter] [widened]\n\nExample:\n[Intro | filtered vocals | telephone effect]\n[Chorus | clean lead vocal | harmonized | widened]\n[Outro | vintage | echo | fade out]" },
    evidence: "version",
    sources: ["使用者提供的 Suno Vocal Direction Cheat Sheet 圖片", "Suno小標籤提示詞 1", "Suno AI God Mode Manual"],
    keywords: ["vocoder", "telephone", "reverb", "distorted", "effects"],
  },
  {
    key: "vocal-placement-space",
    category: "vocal",
    title: { zh: "人聲位置與空間", en: "Vocal placement and space" },
    summary: { zh: "用位置詞控制人聲在聽感中的距離與前後：近、遠、耳邊、中央、背景、遠景、乾聲或寬聲。", en: "Use placement cues to control perceived vocal distance and focus: close, far, in-ear, center, background, distant, dry, or wide." },
    use: { zh: "人聲太遠、太滿、太乾，或想做耳邊／舞台感時", en: "When the vocal is too far, too crowded, too dry, or needs an in-ear or stage perspective" },
    copy: { zh: "位置詞庫：\n[close mic] [far away] [in your ear] [center stage] [background] [in the distance] [dry] [wide]\n\n示範：\n[Verse | close mic | dry | intimate]\n[Chorus | center stage | wide | powerful]\n[Outro | far away | in the distance | echo]", en: "Placement bank:\n[close mic] [far away] [in your ear] [center stage] [background] [in the distance] [dry] [wide]\n\nExample:\n[Verse | close mic | dry | intimate]\n[Chorus | center stage | wide | powerful]\n[Outro | far away | in the distance | echo]" },
    evidence: "field",
    sources: ["使用者提供的 Suno Vocal Direction Cheat Sheet 圖片"],
    keywords: ["close mic", "far away", "in your ear", "center stage", "background", "in the distance", "dry", "wide", "空間"],
  },
  {
    key: "vocal-moments-transitions",
    category: "vocal",
    title: { zh: "人聲段落與轉場時機", en: "Vocal moments and transitions" },
    summary: { zh: "把人聲提示放在真正要發生的段落旁；Intro／Verse／Pre-Chorus／Chorus／Bridge／Drop／Build／Breakdown／Outro／Fade Out 是時機地圖，不是要同時貼上的效果清單。", en: "Place vocal cues beside the section where they should happen; Intro, Verse, Pre-Chorus, Chorus, Bridge, Drop, Build, Breakdown, Outro, and Fade Out are a timing map, not one effects list to paste everywhere." },
    use: { zh: "想讓人聲跟著歌曲能量弧線改變時", en: "When the vocal needs to follow the song's energy arc" },
    copy: { zh: "[Intro | haunting | far away]\n[Verse | close mic | dry | soft]\n[Pre-Chorus | breathy | build]\n[Chorus | center stage | powerful | harmonized]\n[Bridge | broken | vulnerable | background]\n[Drop | intense | hit hard]\n[Breakdown | calm | in the distance]\n[Outro | echo | fade out]", en: "[Intro | haunting | far away]\n[Verse | close mic | dry | soft]\n[Pre-Chorus | breathy | build]\n[Chorus | center stage | powerful | harmonized]\n[Bridge | broken | vulnerable | background]\n[Drop | intense | hit hard]\n[Breakdown | calm | in the distance]\n[Outro | echo | fade out]" },
    evidence: "field",
    sources: ["使用者提供的 Suno Vocal Direction Cheat Sheet 圖片"],
    keywords: ["intro", "verse", "pre-chorus", "chorus", "bridge", "drop", "build", "breakdown", "outro", "fade out", "轉場"],
  },
  {
