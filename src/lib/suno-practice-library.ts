...
export const SUNO_PROMPT_MOVES: SunoTechnique<SunoPromptCategory>[] = [
  ...
  },
  {
    key: "prompt-focus",
    category: "foundation",
    title: { zh: "少而準，不要標籤塞車", en: "Fewer, sharper signals" },
    summary: { zh: "優先放最重要的曲風與情緒。兩種曲風、三至四件主樂器、兩種情緒是好用的起跑點，不是硬性上限。", en: "Lead with the dominant genre and mood. Two genres, three to four lead instruments, and two moods are a practical starting point, not a hard platform limit." },
    use: { zh: "結果混濁、風格互相打架時", en: "When the result feels unfocused or contradictory" },
    copy: { zh: "[主曲風], [次曲風], [情緒 1], [情緒 2], [樂器 1], [樂器 2], [樂器 3]", en: "[Primary genre], [Secondary genre], [Mood 1], [Mood 2], [Instrument 1], [Instrument 2], [Instrument 3]" },
    evidence: "field",
    sources: ["愛波哥的 Suno 聖經 2026 V1", "Suno AI God Mode Manual"],
    keywords: ["front load", "less", "衝突", "權重"],
  },
  {
