...
const SUNO_STUDIO_MASTERING_AUDIO_PREVIEW_ASSETS = [
  ...
  ["studio-mastering-classic-disco", "classic-disco"],
  ["studio-mastering-italo-disco", "italo-disco"],
  ["studio-mastering-eurodisco", "eurodisco"],
  ["studio-mastering-hi-nrg-disco", "hi-nrg-disco"],
  ["studio-mastering-boogie-post-disco", "boogie-post-disco"],
