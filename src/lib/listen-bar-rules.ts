import { MUSIC_GENRE_OPTIONS } from "./music-genres.ts";
...
export const LISTEN_BAR_ACTIVE_GENRE_COUNT = MUSIC_GENRE_OPTIONS.length;
...
export const LISTEN_BAR_CHALLENGER_OBSERVATION_HOURS = 36;
