...
const dict: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    home_avatar_upload_link: '頭像上傳（裁切）',
    profile_title: '個人資料',
    ...
    setup_avatar_upload_btn: '頭像上傳（裁切）',
  ...
  en: {
    ...
    home_avatar_upload_link: 'Upload avatar (crop)',
    ...
    setup_avatar_upload_btn: 'Upload avatar (crop)',
